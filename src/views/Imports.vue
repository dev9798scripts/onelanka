  ...
  <div id="Imports">
    <v-app>
      ...
      <div v-if="getItem.length != 0 && Activate.length != 0">
        ...
        <div class="row m-0">
          <div
            class="col-xl-12 note_div"
            v-if="Activate[0].Import_Activate_Import_Notes === 'true'"
          >
        ...
        <div
          class="row m-0"
          v-if="Activate[0].Import_Activate_Import_Products === 'true'"
        >
              ...
              >
                <template>
                  <v-card class="mx-auto" max-width="344">
                    ...
                    <v-card-subtitle>
                      <v-btn text @click="viewProduct(items)">{{
                        items.Name
                      }}</v-btn>
                    </v-card-subtitle>
                  </v-card>
          ...
          >
            <v-card tile>
              <v-toolbar dark color="primary">
                ...
                <v-toolbar-title v-if="getEditItem != 0">{{
                  getEditItem[0].Name
                }}</v-toolbar-title>
                <v-spacer></v-spacer>
                <v-toolbar-items>
                  <v-btn dark text to="/contactus" style="text-decoration:none"
                    >Contact us</v-btn
                  >
                </v-toolbar-items>
              </v-toolbar>
                        ...
                        <div class="row">
                          <div class="col-xl-6">
                            ...
                            <div class="row">
                              <div class="col-xl-12">
                                <div
                                  v-for="(items, index) in getEditItem[0].image"
                                  :key="index"
                                >
                                  <v-img
                                    :src="
                                    ...
                                    @mouseover="imgSelected(items.img)"
                                  ></v-img>
                                </div>
                              </div>
                            </div>
