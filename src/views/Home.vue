      ...
      <div class="col-xl-12" v-if="Activate[0].Home_Activate_Welcome_Section === 'true'">
        <div class="row">
          ...
          >
            ...
            <v-img
              :src="'https://indesk.gq/public/storage/' + getItem[0].Image+'?i=1'"
              class="welcome_image"
              alt
            ></v-img>
      ...
      >
        <v-slide-group v-model="model" show-arrows>
          ...
          <v-slide-item v-slot:default v-for="(items,index) in getProduct[0]" :key="index">
            ...
            >
              <v-img :src="'https://indesk.gq/public/storage/' + items.image[0]['img']" width="100%"></v-img>
                    ...
                    <div class="col-xl-12">
                      <div class="row">
                        <div class="col-xl-6">
                          ...
                          <v-img
                            :src="'https://indesk.gq/public/storage/' + getEditItem[0].image[0].img"
                          ...
                          <div class="row">
                            <div class="col-xl-12">
                              <div v-for="(items,index) in getEditItem[0].image" :key="index">
                                <v-img
                                  :src="'https://indesk.gq/public/storage/' + items.img"
